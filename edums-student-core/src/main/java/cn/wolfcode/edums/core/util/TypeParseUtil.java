...
import cn.wolfcode.edums.core.exception.DataParseException;
import cn.wolfcode.edums.core.support.DataType;
...
public final class TypeParseUtil {
    ...
    private static Object getObject(String str, BigDecimal retBig) {
