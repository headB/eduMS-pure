...
public final strictfp class MathUtil {
     ...
     * @return
     */
    public static final BigDecimal calcRate(Number dividend, Number divisor) {
        if (dividend == null || divisor == null || dividend.equals(0) || dividend.equals(0.0)) {
            return BigDecimal.ZERO;
        }
        return new BigDecimal(dividend.toString()).divide(new BigDecimal(divisor.toString()), 2, BigDecimal.ROUND_HALF_UP).multiply(BigDecimal.valueOf(100L));
    }
