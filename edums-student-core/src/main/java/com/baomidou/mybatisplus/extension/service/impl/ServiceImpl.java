...
public class ServiceImpl<M extends BaseMapper<T>, T extends BaseDomain> implements IService<T> {
    ...
    @Override
    public <E extends IPage<T>> E page(E page, QueryObject qo) {
        page.setRecords(baseMapper.pageList(page, qo));
        return page;
    }
