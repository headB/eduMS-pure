...
;layui.define(["laytpl", "layer"], function (e) {
    ...
    i.loading = function (e) {
        ...
        layui.data(r.tableName, {key: r.request.tokenName, remove: !0}), location.hash = "/login"
    }, i.req = function (e) {
        ...
        if (e.data = e.data || {}, e.headers = e.headers || {}, n.tokenName) {
            var d = "string" == typeof e.data ? JSON.parse(e.data) : e.data;/*e.data[n.tokenName]=n.tokenName in d?e.data[n.tokenName]:layui.data(r.tableName)[n.tokenName]||"",*/
